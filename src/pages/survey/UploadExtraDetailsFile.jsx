...
const UploadExtraDetailsFile = () => {
  const [extraDetailsfiles, setExtraDetailsFiles] = useState([]);
  ...
  console.log(data);
  console.log("extraDetailsfiles = " + extraDetailsfiles);

  const handleExtraDetailsChange = (e) => {
    for (let i=0; i< e.target.files.length;i++){
      const newImage = e.target.files[i];
      newImage["id"] = "extraDetails"+ Math.random().toString();
      //newImage["id"] = Math.random();
      //newImage["category_name"] = i.toString() + "_extraDetails";
      //newImage["category_name"] = "extraDetails";
      setExtraDetailsFiles((prevState) => [...prevState, newImage]);
    }
  }

  const nextpart = (e) => {
    setData({"img": extraDetailsfiles})
    
    surveyData["extraDetailsImages"] = extraDetailsfiles;
    //surveyData["category_name"] = "extraDetails";
        ...
        <Navbar />
          ...
          <div className="card card-plain">
                ...
                <div className="card-header text-center">
                  ...
                  <h5 className="info-text">Upload Images of any other images that are essential to the project</h5>
                      <div className="row justify-content-center">
                        <div className="col-lg-10 text-center">
                                    <form id ="extraDetails">
                                       
                        <div className="row justify-content-center" data-provides="fileinput">
                        
                              {extraDetailsfiles.map((extraDetailsfile, i) => (
                               <div className="row fileinput fileinput-new thumbnail" style={{ padding:20, marginTop: "0px" }}> 
                                ...
                                src={
                                  extraDetailsfile
                                    ? URL.createObjectURL(extraDetailsfile)
                                    : extraDetailsimagePlaceholder
                                }
                                alt=""
                                ...
                                <div>
                                    <span className="btn btn-primary btn-simple btn-file">
                                        <label htmlFor="file">Other Images</label>
...
export default UploadExtraDetailsFile;
